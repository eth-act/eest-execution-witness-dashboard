...
ZKEVM_WORKLOAD_GUEST_ARTIFACT_BASE_URL="${ZKEVM_WORKLOAD_GUEST_ARTIFACT_BASE_URL:-}"
...
EL_CLIENTS="${EL_CLIENTS:-go-ethereum,ethrex,nethermind,nimbus-el,besu}"
...
export ZKEVM_WORKLOAD_RUNS ZKEVM_RAYON_THREADS
export ZKEVM_WORKLOAD_EXECUTION_CLIENT ZKEVM_WORKLOAD_ZKVM ZKEVM_WORKLOAD_GUEST_ARTIFACT_BASE_URL ZKEVM_METRICS_DIR
export EL_CLIENT_CONFIG EL_GUEST_CONFIG EL_CLIENTS EL_CLIENT_OVERRIDES_JSON
...
eest_dashboard_print_env() {
  ...
  for name in \
    ...
    ZKEVM_WORKLOAD_RUNS ZKEVM_RAYON_THREADS \
    ZKEVM_WORKLOAD_EXECUTION_CLIENT ZKEVM_WORKLOAD_ZKVM ZKEVM_WORKLOAD_GUEST_ARTIFACT_BASE_URL ZKEVM_METRICS_DIR \
    EL_CLIENT_CONFIG EL_GUEST_CONFIG EL_CLIENTS EL_CLIENT_OVERRIDES_JSON \
